...
void run_user_template()
{
  ...
  * correctly).
  */
 user_template_test = create_test(&user_template_data,tsamples,psamples,&user_template);
  ...
  */
 show_test_header(&user_template_data,&user_template_test);
  ...
  */
 printf("# Lag used in %s test: %u\n",user_template_data.name,user_template_lag);
  ...
  */
 user_template_lag = (int)x_user;
 std_test(&user_template_data,&user_template_test);
  ...
  */
 show_test_results(&user_template_data,&user_template_test);
