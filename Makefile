...
DIEHARDER_LIB_VERSION = 3.29.1
DIEHARDER_LT_VERSION = 3:29:1
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
ECHO_N = -n
...
PACKAGE_STRING = dieharder 3.29.1beta
PACKAGE_TARNAME = dieharder
PACKAGE_VERSION = 3.29.1beta
PATH_SEPARATOR = :
RANLIB = ranlib
RELEASE = 1
RELEASED = 
...
RDHTAR = RDieHarder_3.29.1beta.tar
RDHPKG = RDieHarder_3.29.1beta.tar.gz
all: config.h
