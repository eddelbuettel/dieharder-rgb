...
DIEHARDER_LIB_VERSION = 3.29.3
DIEHARDER_LT_VERSION = 3:29:3
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
ECHO_N = -n
...
PACKAGE_STRING = dieharder 3.29.3beta
PACKAGE_TARNAME = dieharder
PACKAGE_VERSION = 3.29.3beta
PATH_SEPARATOR = :
RANLIB = ranlib
RELEASE = 1
RELEASED = 
...
RDHTAR = RDieHarder_3.29.3beta.tar
RDHPKG = RDieHarder_3.29.3beta.tar.gz
all: config.h
