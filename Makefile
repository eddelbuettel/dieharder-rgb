...
DIEHARDER_LIB_VERSION = 3.29.2
DIEHARDER_LT_VERSION = 3:29:2
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
ECHO_N = -n
...
PACKAGE_STRING = dieharder 3.29.2beta
PACKAGE_TARNAME = dieharder
PACKAGE_VERSION = 3.29.2beta
PATH_SEPARATOR = :
RANLIB = ranlib
RELEASE = 1
RELEASED = 
...
RDHTAR = RDieHarder_3.29.2beta.tar
RDHPKG = RDieHarder_3.29.2beta.tar.gz
all: config.h
